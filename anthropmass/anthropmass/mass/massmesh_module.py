...
# %% auto 0
__all__ = ['create_truncated_cone', 'create_elliptical_frustum_solid', 'create_elliptical_cylinder', 'mirror_mesh',
           'rotate_hand_mesh', 'rotate_foot_mesh', 'shift_to_bottom', 'generate_all_meshes',
